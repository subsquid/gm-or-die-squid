...
export interface Call_CarrotOnAStick {
  __kind: 'CarrotOnAStick'
  value: CarrotOnAStickCall
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CarrotOnAStickCall = CarrotOnAStickCall_claim | CarrotOnAStickCall_vested_transfer | CarrotOnAStickCall_update_vesting_schedules | CarrotOnAStickCall_claim_for

export interface CarrotOnAStickCall_claim {
  __kind: 'claim'
}

export interface CarrotOnAStickCall_vested_transfer {
  __kind: 'vested_transfer'
  dest: MultiAddress
  schedule: VestingSchedule
}

export interface CarrotOnAStickCall_update_vesting_schedules {
  __kind: 'update_vesting_schedules'
  who: MultiAddress
  vestingSchedules: VestingSchedule[]
}

export interface CarrotOnAStickCall_claim_for {
  __kind: 'claim_for'
  dest: MultiAddress
}
...
export type Type_197 = Type_197_Relay | Type_197_SiblingParachain

export interface Type_197_Relay {
  __kind: 'Relay'
}

export interface Type_197_SiblingParachain {
...
export type Event = Event_System | Event_ParachainSystem | Event_Sudo | Event_Treasury | Event_Identity | Event_Utility | Event_Balances | Event_TransactionPayment | Event_Tokens | Event_Currencies | Event_CollatorSelection | Event_Session | Event_XcmpQueue | Event_PolkadotXcm | Event_CumulusXcm | Event_DmpQueue | Event_OrmlXcm | Event_CarrotOnAStick
...
export interface Event_CarrotOnAStick {
  __kind: 'CarrotOnAStick'
  value: CarrotOnAStickEvent
}
 ...
 */
export type CarrotOnAStickEvent = CarrotOnAStickEvent_VestingScheduleAdded | CarrotOnAStickEvent_Claimed | CarrotOnAStickEvent_VestingSchedulesUpdated

/**
 * Added new vesting schedule.
 */
export interface CarrotOnAStickEvent_VestingScheduleAdded {
 ...
 * Claimed vesting.
 */
export interface CarrotOnAStickEvent_Claimed {
  __kind: 'Claimed'
  who: Uint8Array
  amount: bigint
}
 ...
 */
export interface CarrotOnAStickEvent_VestingSchedulesUpdated {
